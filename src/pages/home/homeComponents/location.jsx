...
export default function LocationSection() {
    return (
        <Box id="LocationSection" sx={{ minHeight: '100vh', py: { xs: 4, md: 8 }, px: 0 }}>
            <Grid container spacing={10} justifyContent="center" alignItems="center" sx={{ maxWidth: "80vw", mx: 'auto', px: 0, '& > .MuiGrid-item': { pl: 0 } }}>

                {/* Localização */}

                <Grid container item xs={12} md={12} spacing={4} sx={{ display: 'flex', flexDirection: 'row' }}>
